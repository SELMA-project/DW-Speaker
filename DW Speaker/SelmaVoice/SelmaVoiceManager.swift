...
public class SelmaVoiceManager {
...
// MARK Comunication with SELMA API
extension SelmaVoiceManager {
    
    public func renderSpeech(voiceId: String, text: String, toURL fileURL: URL) async -> Bool {
        ...
        let speakerQueryItem = URLQueryItem(name: "speaker_id", value: voiceId)
